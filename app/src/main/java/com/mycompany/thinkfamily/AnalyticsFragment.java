...
public class AnalyticsFragment extends Fragment implements View.OnClickListener {
    ...
    private TextView mLastVisitsText = null;
...
*/
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        int daysCurrent = c.get(Calendar.DAY_OF_YEAR);

        int setText;
        if(daysCurrent < daysPast){
            setText = 365 - daysPast + daysCurrent;
        }else{
            setText = daysCurrent - daysPast;
        }
        String text = Integer.toString(setText);
