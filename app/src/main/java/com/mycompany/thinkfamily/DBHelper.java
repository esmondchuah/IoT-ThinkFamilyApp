...
public class DBHelper {
    ...
    public long insertActivityReport(int type, long time, int year, int month, int day, int hour, int[] dataArray, String subData) throws SQLiteConstraintException {
        ...
        Log.d(TAG, "+ Insert activity report : mStartTime=" + time + ", Year=" + year + ", Month=" + month + ", Day=" + day + ", Hour=" + hour);
    ...
    public void deleteReportWithID(int id) {
        ...
        synchronized (mDb) {
            int count = mDb.delete(TABLE_NAME_ACCEL_REPORT,
                    ...
                    null); 			// whereArgs
            Log.d(TAG, "- Delete record : id="+id+", count="+count);
        }
    }
    ...
    public void deleteReportWithType(int type) {
        ...
        synchronized (mDb) {
            int count = mDb.delete(TABLE_NAME_ACCEL_REPORT,
                    ...
                    null); 			// whereArgs
            Log.d(TAG, "- Delete record : type="+type+", deleted count="+count);
        }
    }
    ...
    public void deleteReportWithTime(int type, long timeBiggerThan, long timeSmallerThan) {
        ...
        synchronized (mDb) {
            int count = mDb.delete(TABLE_NAME_ACCEL_REPORT,
                    ...
                    null); 			// whereArgs
            Log.d(TAG, "- Delete record : type="+type+", "+timeBiggerThan+" < time < "+timeSmallerThan+", deleted count="+count);
        }
    }
